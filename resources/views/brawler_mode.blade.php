...
>
    <head>
        <meta charset="utf-8" />
        <title>BrawlWorld</title>
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Webflow" name="generator" />
        <link
            href="https://uploads-ssl.webflow.com/64e71f3f7303690218eb5b32/css/brawl-world.webflow.9b16aaaf6.css"
            rel="stylesheet"
            type="text/css"
        />
    ...
    <body>
        ...
        <div class="w-layout-grid grid">
            <x-brawler_mode_stat :brawlers="$brawlers"/>
        <script
